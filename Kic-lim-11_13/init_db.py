...
cursor.executemany("INSERT INTO deductions (name, rate) VALUES (?, ?)", deductions_list)

# [수정] (name, base_salary) 2개 값을 삽입합니다.
cursor.executemany("INSERT INTO positions (name, base_salary) VALUES (?, ?)", positions_list)
